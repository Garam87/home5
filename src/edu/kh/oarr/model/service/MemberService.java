...
private Scanner sc = new Scanner(System.in);
	...
	public MemberService() { // 기본 생성자
		...
		memberArr[0] = new Member("user01", "01", "홍길동", 30, "서울");
		memberArr[1] = new Member("user02", "02", "홍길순", 20, "부산");
		memberArr[2] = new Member("user03", "03", "홍길당", 10, "광주");
	...
	public int emptyIndex() {
		...
		// for문을 수행했지만 return이 되지 않은 경우 해당 위치 코트가 수행!
